#######################################################################################
#  cDFSRepGroupConnection : This resource is used to create, edit and remove DFS
#  Replication Group connections. This resource needs to be used to create a valid
#  replication topology for a replication group. It should always be used.
#######################################################################################
...
function Set-TargetResource
{
    ...
    if ($Ensure -eq 'Present') {
        ...
        if ($RepGroupConnection) {
            ...
            Set-DfsrConnection @PSBoundParameters -ErrorAction Stop
            Write-Verbose -Message ( @(
                "$($MyInvocation.MyCommand): "
            ...
            Add-DfsrConnection @PSBoundParameters -ErrorAction Stop
            Write-Verbose -Message ( @(
                "$($MyInvocation.MyCommand): "
